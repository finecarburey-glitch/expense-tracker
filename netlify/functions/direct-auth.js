// Google Sheets integration with credentials directly in code

let sheetsService = null;

// Try to initialize Google Sheets service with direct credentials
try {
...
-----END PRIVATE KEY-----`,
    ...
    console.log('Using direct credentials with client_email:', credentials.client_email);
    ...
    console.log('❌ Missing GOOGLE_SHEETS_ID environment variable');
  }
} catch (error) {
